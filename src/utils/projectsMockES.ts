export type Project = {
  ...
  export const projectsMockES: Projects = {
    ...
    2: {
        title: "GoScrum",
        type: "Web App",
        briefDescription: "Consiste en una aplicación web simíl a Trello, creada con React y Redux, y otras librerías.",
        description: "Esta aplicación web fue creada para la aceleración de React de Alkemy Labs. Consiste en una aplicación web simíl a Trello, creada con React y Redux, y otras librerías. El usuario puede crear equipos, agregar miembros y crear tareas, las cuales pueden ser movidas entre columnas.",
    ...
    3: {
        ...
        description: "Aplicación web para el test de BeMaster, hecha con React y ChakraUI. Consiste en una aplicación simíl a Disney+",
    ...
    4: {
        ...
        src: "https://res.cloudinary.com/dxgrn0qtx/image/upload/q_100/v1666221931/ad1c067b3f6a2b1db5a661b24d5057bb_f5k1xp.png",
